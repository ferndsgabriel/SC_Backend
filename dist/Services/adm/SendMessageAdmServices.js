...
exports.SendMessageAdmServices = void 0;
const prisma_1 = __importDefault(require("../../prisma"));
class SendMessageAdmServices {
    execute({ content, apartment_id, date }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!content || !apartment_id || !date) {
                throw new Error('Preencha todos os campos');
            }
            let conversationId = '';
            const findConversation = yield prisma_1.default.conversation.findFirst({
                where: {
...
exports.SendMessageAdmServices = SendMessageAdmServices;
