...
CREATE TABLE "Taxed" (
    ...
    "email" TEXT NOT NULL,
    "phone_number" TEXT NOT NULL,
    "dateGuest" TIMESTAMP(3) NOT NULL,
    "dateCancellation" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "Taxed_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Taxed" ADD CONSTRAINT "Taxed_apartment_id_fkey" FOREIGN KEY ("apartment_id") REFERENCES "Apartment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
